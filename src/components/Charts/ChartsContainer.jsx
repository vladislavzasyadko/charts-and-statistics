    ...
    parseData = () => {
        ...
        this.props.data.map((mass) => {
            if (sortedData.has(mass[1])) {
                ...
                sortedData.set(mass[1], [
                    { category: mass[2], value: mass[3] },
                ]);
            }
        });
            ...
            <div>
                ...
                {!this.state.scaleMode && (
                    <div>
                        {data.map((dataset) => (
                            <Charts
                                scaleAllToOne={this.scaleAllToOne}
...
export default compose(connect(mapStateToProps, { getData }))(ChartsContainer);
